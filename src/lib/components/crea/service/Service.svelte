...
<div class="pt-[120px] pb-[50px] bg-[#f4f3fc] dark:bg-[#0C0C12] flex justify-center items-center" id="biographie">
  ...
  <div class="bg-[#d4d5e2] dark:bg-[#14141E] flex items-center w-[1000px] p-5 rounded-[10px]" id="bio-container">
    ...
    <div class="flex flex-col" id="bio-text">
      <h1 class="text-[50px] mb-[30px] font-family: 'Outfit', sans-serif dark:text-white font-black"><span class="font-extrabold text-[#ff9900] dark:text-[#FFC000]">Développement</span> <span class="font-semibold text-[#4e59d8] dark:text-[#5865f2]">Web</span></h1>
