...
<div class="fixed top-0 left-0 flex items-center justify-center w-full z-50 pt-5 pb-5" id="navbar">
  ...
  <div class="group bg-[#d4d5e2] dark:bg-[#14141E] cursor-pointer h-max w-max rounded-[20px] border-2 border-solid border-[#aaabbb] dark:border-[#868796] hover:bg-[#bdbeca] dark:hover:bg-[#23232e] hover:border-2 hover:border-[#9697a5] dark:hover:border-[#b5b6c9]" id="theme" on:click={toggleTheme} role="button" tabindex="0" on:keydown={e => {if (e.key === 'Enter') toggleTheme()}}>
  ...
  <div class="group bg-[#d4d5e2] dark:bg-[#14141E] cursor-pointer h-max w-max rounded-[20px] border-2 border-solid border-[#aaabbb] dark:border-[#868796] hover:bg-[#bdbeca] dark:hover:bg-[#23232e] hover:border-2 hover:border-[#9697a5] dark:hover:border-[#b5b6c9]" id="langue">
    <button class="mx-[10px] my-[10px]">
